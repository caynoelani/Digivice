...
This project is written in `Python` using the `Flask framework`, `Jinja2`, and `[Digimon API](https://digimon-api.com)`. Users can register and login, as well as save their favorite Digimon with the use of a `MySQL` database. All queries are done manually without the use of an ORM.
